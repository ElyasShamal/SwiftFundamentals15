...
// When we use division operator / on Int values the result will be an Int value
// rounded down to the nearest whole number, because  the Int type only support whole number
// and if we declear a variable as Double value the result will include decimal point.
...
print(even % 2) // output 0
print(odd % 2) // output 1
