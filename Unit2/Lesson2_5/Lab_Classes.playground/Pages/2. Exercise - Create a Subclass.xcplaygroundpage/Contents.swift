...
print("We cannot print falcon.weapon becouse falcon is a spaceShip, not a Fighter")
print("Weapon only exists in the Fighter subclass, not in spaceShip object" )
