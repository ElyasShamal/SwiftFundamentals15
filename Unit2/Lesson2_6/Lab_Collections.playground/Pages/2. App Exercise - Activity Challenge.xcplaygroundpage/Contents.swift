 ...
 */
let walkingChallenges = ["Walk 3 mile a day", "walk 5000 steps daily"]
let runningChallenges = ["Run 3 times a week", "Run a 5k race"]
...
if committedChallenges.isEmpty {
    ...
    print("The challenge you have chose is \(committedChallenges[0])")
}else{
