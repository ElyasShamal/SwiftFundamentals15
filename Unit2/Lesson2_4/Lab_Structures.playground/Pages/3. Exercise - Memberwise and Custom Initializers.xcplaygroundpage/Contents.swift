...
let favoriteBook = Book(title: "Clean Code", author: "Robert C Martin", pages: 464, price: 27.99)
...
var macBook = LopTop(yearPurchased: 2023)
var gamingLoptop = LopTop(screenSize: 17, repairCount: 1, yearPurchased: 2024)
...
var someonesHeight = Heigh(inches: 65)
