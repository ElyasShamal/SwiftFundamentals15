...
var elyas = User(name : "Elyas", age: 25, height: 70, weight: 155, activityLevel: 10)
print("User info: \(elyas.name) is \(elyas.age) years old, \(elyas.height) inches tall, \(elyas.weight) lbs weight, and has an activity level of \(elyas.activityLevel) ")
...
let shorterRun = Distance(feet: 300)
print(shorterRun.meters)
print(shorterRun.feet)
